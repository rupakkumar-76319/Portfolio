...
const categories = [
  { id: 'all', label: 'All Projects', color: 'var(--text-primary)', bg: 'transparent' },
  { id: 'ai-eng', label: 'AI Eng.', color: '#ff6b35', bg: '#7b2fff' },
  { id: 'ml-eng', label: 'ML Eng.', color: '#00d4ff', bg: '#00d4ff' },
  { id: 'data-analysis', label: 'Data Analysis', color: '#00ffaa', bg: '#00ffaa' },
  { id: 'power-bi', label: 'Power BI', color: '#f2c811', bg: '#f2c811' },
]
...
export default function ProjectsSection() {
  ...
  }, [activeFilter]) // Re-run observer when filter changes to animate new cards
  ...
  return (
    <section id="projects" className="projects-section" ref={ref}>
      <div className="container">
        ...
        {/* Filters */}
        <div className="project-filters proj-reveal">
          {categories.map(cat => {
        ...
        <div className="projects-grid">
          {filteredProjects.map((proj, i) => {
            const catObj = categories.find(c => c.id === proj.category) || categories[0];
            
            return (
              <div
                key={proj.id}
                className="project-card card proj-reveal"
                style={{ transitionDelay: `${i * 0.12}s`, '--proj-color': catObj.color, '--proj-bg': catObj.bg }}
              >
                {/* Top bar */}
                ...
                <div className="project-category-badge" style={{ backgroundColor: catObj.bg }}>
                  {catObj.label}
                </div>

                <h3 className="project-title" style={{ color: catObj.color }}>{proj.title}</h3>
          ...
          <div className="project-card project-placeholder proj-reveal" style={{ transitionDelay: `${filteredProjects.length * 0.12}s` }}>
